...
// *************************************************************************
#[starknet::interface]
trait ILiquidationHandlerRouter<TContractState> {
...
mod LiquidationHandler {
    ...
    // Local imports.
    use super::ILiquidationHandlerRouter;
    ...
    // Ted
    use satoru::order::liquidation::{
        liquidation_order_utils,
    };
    ...
    // *************************************************************************
    #[abi(embed_v0)]
    impl LiquidationHandlerImpl of super::ILiquidationHandlerRouter<
        ContractState
    > { // executes a position liquidation
        fn execute_liquidation(
            ref self: ContractState,
            ...
            // Ted
            liquidation_order_utils::execute_order(params);
